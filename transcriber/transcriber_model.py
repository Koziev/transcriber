"""
Классы для трансформенной модели фонетических преобразований текста.
"""
...
def create_model(config, input_tokenizer, output_tokenizer):
    embed_dim = 64  #256
    ...
    x = PositionalEmbedding(max_seq_len, input_tokenizer.vocab_size, embed_dim)(encoder_inputs)
    ...
    x = PositionalEmbedding(max_seq_len, output_tokenizer.vocab_size, embed_dim)(decoder_inputs)
    x = TransformerDecoder(embed_dim, latent_dim, num_heads)(x, encoded_seq_inputs)
    x = layers.Dropout(0.1)(x)  # 0.5
    decoder_outputs = layers.Dense(output_tokenizer.vocab_size, activation="softmax")(x)
